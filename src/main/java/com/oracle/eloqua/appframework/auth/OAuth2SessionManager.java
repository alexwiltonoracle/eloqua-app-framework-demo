...
public class OAuth2SessionManager {
	...
	private String clientId = "e0d9dfe3-3023-4253-8f13-d11ab40dd8c8";
	private String clientSecret = "1ZePPEp4KKEmPOEwvoFAvmbB7J3jvwDNgieiBLd-zC8ne0Qf9AFuQc327IjKLM8Kmu4Ez6BYI3dkI7BDUB9KDAOrPg9ehxtlz8Nb";
	
	private String tokenUrl = "https://login.eloqua.com/auth/oauth2/token";

	private String redirectUri = "https://eloqua-app-framework.ngrok.io/auth/callback";
